...
In addition, we analyzed homophily between nodes based on attributes such as gender, country, and age. Our analysis showed that these attributes may influence the formation and maintenance of relationships within the network. For example, we found that actors are more likely to be connected to other actors from the same country but on the other hand, some attribute (as age, height, even gender) were not significants to affirm a relevant role in the fomation of link between actors by similarity. 
